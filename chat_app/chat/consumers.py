...
class ChatConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def receive_json(self, text_data=None, byte_data=None):
        ...
        try:
            ...
            print(f"KeyError: {e}. Make sure 'message' and 'to_user' keys are present in the received data.")
            return
    ...
    def get_user_channel(self, to_user):
        try:
            ...
            channel_name = send_user_channel.channel
    ...
    def save_message(self, room, user, content):
        try:
            ...
            print(f"Error saving chat room participants: {e}")
        ...
        try:
            ...
            chatroom.save()  # Add save to update the chatroom
        except Exception as e:
            print(f"Error finding chat room: {e}")
